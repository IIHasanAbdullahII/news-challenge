...
class _$NewsEntityImpl implements _NewsEntity {
  const _$NewsEntityImpl({this.news});
...
abstract class _NewsEntity implements NewsEntity {
  const factory _NewsEntity({final News? news}) = _$NewsEntityImpl;
...
abstract class $NewsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? status, int? totalResults, List<dynamic>? articles});
}
...
class _$NewsImpl implements _News {
  const _$NewsImpl(
      {this.status, this.totalResults, final List<dynamic>? articles})
      : _articles = articles;
...
abstract class _News implements News {
  const factory _News(
      {final String? status,
      final int? totalResults,
      final List<dynamic>? articles}) = _$NewsImpl;
